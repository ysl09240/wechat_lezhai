package com.slin.weixin.main;

import com.slin.weixin.menu.Button;
import com.slin.weixin.menu.CommonButton;
...
public class MenuManager {
    ...
    public static void main(String[] args) {
        ...
        if (null != at) {
            // 调用接口创建菜单
            int result = MenuUtil.createMenu(getMenu(), at.getAccessToken());
